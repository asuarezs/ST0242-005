...
public class Tablero {
    ...
    private void leerArchivo() {
        ...
        for (int fila = 0; fila < numFilas; fila++) {
            ...
            for (int col = 0; col < numCols; col++) {
                ...
                // esMuro, esSalida, tienearepita,arepaEx, caracter
                if (c == '*') {
                ...
                if(u>=0.5) {
                    tablero[fila][col].setArepaEx(); 
                }
                }
                
             
                if (c == 'O') {
                    tablero[fila][col] = new Celda(false, true, false,false, null);
                }
     ...
     * A cada celda se le invoca el método "caracterCelda", que devuelve
